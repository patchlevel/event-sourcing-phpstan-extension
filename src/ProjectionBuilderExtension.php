...
final class ProjectionBuilderExtension implements DynamicMethodReturnTypeExtension
{
    public function getClass(): string
    {
        return ProjectionBuilder::class;
    }
    ...
    public function getTypeFromMethodCall(
        ...
        return $type->traverse(static function (Type $type) use ($scope) {
